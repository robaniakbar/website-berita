	...
	<header>
		...
		<div class="container">
			...
			<ul class="main-menu" id="main-menu">
				...
				<li><a href="{{ url('laptop')}}" class="jawu">LAPTOP</a></li>
			...
			<div class="h-2-3 h-sm-auto oflow-hidden">
				...
				<div class="pb-5 pr-5 pr-sm-0 float-left float-sm-none w-2-3 w-sm-100 h-100 h-sm-300x">
					<a class="pos-relative h-100 dplay-block" href="#">
                        ...
                        <img src="https://blue.kumparan.com/image/upload/fl_progressive,fl_lossy,c_fill,q_auto:best,w_640/v1634025439/01hp0j7adw7ryyn5byz1mgw96n.jpg" width="90" height="400">
						
						<div class="abs-blr color-white p-20 bg-sm-color-7">
							<h3 class="mb-15 mb-sm-5 font-sm-13"><b>Rekomendasi laptop bisnis pertama adalah Acer Swift 5 di harga 11 jutaan</b></h3>
				...
				<div class="float-left float-sm-none w-1-3 w-sm-100 h-100 h-sm-600x">
					...
					<div class="pl-5 ptb-5 pl-sm-0 pos-relative h-50">
						<a class="pos-relative h-100 dplay-block" href="#">
							...
							<img src="https://blue.kumparan.com/image/upload/fl_progressive,fl_lossy,c_fill,q_auto:best,w_1024/v1634025439/01hp0j29z2m3bsw6yred2ajcam.png" width="500" height="200">
							
							<div class="abs-blr color-white p-20 bg-sm-color-7">
								<h4 class="mb-10 mb-sm-5"><a href="#"><b>Advan Workplus : Laptop ini didukung prosesor yang apik, yaitu AMD Ryzen 5 6600H</b></a></h4>
								<ul class="list-li-mr-20">
									<li>Jan 25, 2024</li>
			...
			<div class="h-1-3 oflow-hidden">
				...
				<div class="pr-5 pr-sm-0 pt-5 float-left float-sm-none pos-relative w-1-3 w-sm-100 h-100 h-sm-300x">
					<a class="pos-relative h-100 dplay-block" href="#">
						...
						<img src="https://blue.kumparan.com/image/upload/fl_progressive,fl_lossy,c_fill,q_auto:best,w_1024/v1634025439/01hp0j0cv9e38aqhy8cjrfjdfd.jpg" width="500" height="200">
						
						<div class="abs-blr color-white p-20 bg-sm-color-7">
							<h4 class="mb-10 mb-sm-5"><a href="#"><b>Dell Latitude 5410 merupakan laptop berikutnya yang masuk ke daftar laptop bisnis harga terbaik</b></a></h4>
							<ul class="list-li-mr-20">
								<li>Feb 29, 2024</li>
								<li><i class="color-primary mr-5 font-12 ion-ios-bolt"></i>30,190</li>
				...
				<div class="plr-5 plr-sm-0 pt-5 pt-sm-10 float-left float-sm-none pos-relative w-1-3 w-sm-100 h-100 h-sm-300x">
					<a class="pos-relative h-100 dplay-block" href="#">
						...
						<img src="https://blue.kumparan.com/image/upload/fl_progressive,fl_lossy,c_fill,q_auto:best,w_1024/v1634025439/01hp0hyzvdsz15vrjh8fz794hz.png" width="500" height="200">
						
						<div class="abs-blr color-white p-20 bg-sm-color-7">
							<h4 class="mb-10 mb-sm-5"><a href="#"><b>Laptop Lenovo ThinkPad T15g Gen 2</b></a></h4>
							<ul class="list-li-mr-20">
								<li>Feb 26, 2024</li>
								<li><i class="color-primary mr-5 font-12 ion-ios-bolt"></i>30,190</li>
								<li><i class="color-primary mr-5 font-12 ion-chatbubbles"></i>30</li>
				...
				<div class="pl-5 pl-sm-0 pt-5 pt-sm-10 float-left float-sm-none pos-relative w-1-3 w-sm-100 h-100 h-sm-300x">
					<a class="pos-relative h-100 dplay-block" href="#">
						...
						<img src="https://blue.kumparan.com/image/upload/fl_progressive,fl_lossy,c_fill,q_auto:best,w_640/v1634025439/01hp0hxjf9pgt6vqjrvxpvpr3m.jpg" width="500" height="200">
						
						<div class="abs-blr color-white p-20 bg-sm-color-7">
							<h4 class="mb-10 mb-sm-5"><a href="#"><b>HP ProBook 430 G8 adalah laptop yang cocok untuk menjalankan pekerjaan bisnis</b></a></h4>
							<ul class="list-li-mr-20">
								<li>Jan 17, 2024</li>
								<li><i class="color-primary mr-5 font-12 ion-ios-bolt"></i>30,190</li>
								<li><i class="color-primary mr-5 font-12 ion-chatbubbles"></i>30</li>
