	...
	<header>
		...
		<div class="container">
			...
			<ul class="main-menu" id="main-menu">
				...
				<li><a href="{{ url('smartphone')}}" class="jawu">SMARTPHONE</a></li>
			...
			<div class="h-2-3 h-sm-auto oflow-hidden">
				...
				<div class="pb-5 pr-5 pr-sm-0 float-left float-sm-none w-2-3 w-sm-100 h-100 h-sm-300x">
					<a class="pos-relative h-100 dplay-block" href="#">
                        ...
                        <img src="https://www.stuff.tv/wp-content/uploads/sites/2/2022/11/Stuff-Best-Smartphone-Lead.png" width="90" height="400">
						
						<div class="abs-blr color-white p-20 bg-sm-color-7">
							<h3 class="mb-15 mb-sm-5 font-sm-13"><b>Best smartphone 2024: Apple and Android phones reviewed</b></h3>
							<ul class="list-li-mr-20">
								<li>by <span class="color-primary"><b>Daman Alfarizy</b></span> Maret 10, 2024</li>
				...
				<div class="float-left float-sm-none w-1-3 w-sm-100 h-100 h-sm-600x">
					...
					<div class="pl-5 pb-5 pl-sm-0 ptb-sm-5 pos-relative h-50">
						<a class="pos-relative h-100 dplay-block" href="#">
							...
							<img src="https://asset.kompas.com/crops/PaJ5sXPQEx5M4QIKp7BqWDsHxdc=/118x112:1107x771/750x500/data/photo/2024/01/06/6598a67f50873.png" width="500" height="200">
							
							<div class="abs-blr color-white p-20 bg-sm-color-7">
								<h4 class="mb-10 mb-sm-5"><a href="#"><b>Xiaomi Redmi Note 13 Series Masuk Indonesia Februari 2024</b></a></h4>
								<ul class="list-li-mr-20">
									<li>Feb 25, 2024</li>
									<li><i class="color-primary mr-5 font-12 ion-ios-bolt"></i>30,190</li>
					...
					<div class="pl-5 ptb-5 pl-sm-0 pos-relative h-50">
						<a class="pos-relative h-100 dplay-block" href="#">
							...
							<img src="https://diajartekno.com/wp-content/uploads/2023/12/Infinix-Note-30-Pro.png" width="500" height="200">
							
							<div class="abs-blr color-white p-20 bg-sm-color-7">
								<h4 class="mb-10 mb-sm-5"><a href="#"><b>8 Harga HP Infinix Terbaru 2024, Cek Spesifikasi Lengkap Disini</b></a></h4>
								<ul class="list-li-mr-20">
									<li>Jan 26, 2024</li>
			...
			<div class="h-1-3 oflow-hidden">
				...
				<div class="pr-5 pr-sm-0 pt-5 float-left float-sm-none pos-relative w-1-3 w-sm-100 h-100 h-sm-300x">
					<a class="pos-relative h-100 dplay-block" href="#">
						...
						<img src="https://asset.kompas.com/crops/M3n2AAnPsDsbJfvWEnQgBEzTQSE=/161x0:1976x1210/750x500/data/photo/2021/03/24/605a835529706.jpg" width="500" height="200">
						
						<div class="abs-blr color-white p-20 bg-sm-color-7">
							<h4 class="mb-10 mb-sm-5"><a href="#"><b>Ponsel Gaming Xiaomi Black Shark 4 dan Black Shark 4 Pro Resmi Dirilis, Ini Harganya</b></a></h4>
							<ul class="list-li-mr-20">
								<li>Feb 29, 2024</li>
								<li><i class="color-primary mr-5 font-12 ion-ios-bolt"></i>30,190</li>
				...
				<div class="pl-5 pl-sm-0 pt-5 pt-sm-10 float-left float-sm-none pos-relative w-1-3 w-sm-100 h-100 h-sm-300x">
					<a class="pos-relative h-100 dplay-block" href="#">
						...
						<img src="https://i0.wp.com/www.rakyatpos.id/wp-content/uploads/2023/10/Google-Pixel-9-Rumor-spesifikasi-dan-apa-yang-ingin-Anda.jpg?fit=800%2C451&ssl=1" width="500" height="200">
						
						<div class="abs-blr color-white p-20 bg-sm-color-7">
							<h4 class="mb-10 mb-sm-5"><a href="#"><b>Google Pixel 9: Rumor, spesifikasi, dan apa yang ingin Anda lihat</b></a></h4>
							<ul class="list-li-mr-20">
								<li>Jan 17, 2024</li>
								<li><i class="color-primary mr-5 font-12 ion-ios-bolt"></i>30,190</li>
								<li><i class="color-primary mr-5 font-12 ion-chatbubbles"></i>30</li>
